...
<head>
    ...
    <!--     Fonts and icons     -->
    <link href="assets/http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
    ...
    <!--   you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple" -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="assets/user.php">
                        <i class="pe-7s-user"></i>
                        <p>User Profile</p>
                    </a>
                </li>
                <li>
                    <a href="assets/table.php">
                        <i class="pe-7s-note2"></i>
                        <p>Table List</p>
                    </a>
                </li>
                <li>
                    <a href="assets/typography.php">
                        <i class="pe-7s-news-paper"></i>
                        <p>Typography</p>
                    </a>
                </li>
                <li>
                    <a href="assets/icons.php">
                        <i class="pe-7s-science"></i>
                        <p>Icons</p>
                    </a>
                </li>
                <li>
                    <a href="assets/maps.php">
                        <i class="pe-7s-map-marker"></i>
                        <p>Maps</p>
                    </a>
                </li>
                <li class="active">
                    <a href="assets/notifications.php">
                        <i class="pe-7s-bell"></i>
                        <p>Notifications</p>
                    </a>
                </li>
				<li class="active-pro">
                    <a href="assets/upgrade.php">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">Handcrafted by our friend <a target="_blank" href="assets/https://github.com/mouse0270">Robert McIntosh</a>. Please checkout the <a href="assets/http://bootstrap-notify.remabledesigns.com/" target="_blank">full documentation.</a></p>
