        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 service-left-matter">
                ...
                <div class="row my-lg-4 my-3">
                    ...
                    <p class="mt-2">It is a crucial part of the communication between the user and us. Let me know if you have any questions or comments.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 col-md-6 contact-form pb-lg-3 pb-2">
                <form action="<?= SITE_URL ?>/controllers/user-controller.php" method="post">
                    <div class="form-group contact-forms">
                        <input type="text" class="form-control" name="txt_name" placeholder="Name" required tabindex="10">
                    </div>
                    <div class="form-group contact-forms">
                        <input type="email" class="form-control" name="txt_email" placeholder="Email" required tabindex="11">
                    </div>
                    <div class="form-group contact-forms">
                        <input type="text" class="form-control" name="txt_phone" placeholder="Phone" required tabindex="12">
                    </div>
                    <div class="form-group contact-forms">
                        <textarea class="form-control" placeholder="Message" name="txt_msg" required tabindex="13"></textarea>
                    </div>
                    <button type="submit" name="btn_contact" class="btnn sent-butnn btn-lg" tabindex="14">Send</button>
                </form>
            </div>
        </div>
    </div>
