...
<html lang="en">
<head>
	<title>Forgot Password | Seller</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="/project_adi/admin/php_code.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username/Email is reauired">
					...
					<div class="text-right p-t-8 p-b-31">
						<a href="forgot_Seller.php" tabindex="4">
							Forgot password?
						</a>
					</div>
					-->
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button type="submit" tabindex="3" name="btn_seller_forgot" class="login100-form-btn">
								SEND OTP
							</button>
						</div>
					</div>
					<hr/>
					<a href="login_Seller.php" class="txt2" tabindex="5" style="float:right"> Back To Login </a>
