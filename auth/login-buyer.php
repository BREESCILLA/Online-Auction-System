...
<html lang="en">
<head>
    <title>Login | Buyer - Online Auction System</title>
    <meta charset="UTF-8">
            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="/project_adi/controllers/auth-controller.php" method="post">
                    ...
                    <div class="text-right p-t-8 p-b-31">
                        <a href="forgot-password.php?type=buyer" tabindex="4">
                            Forgot password?
                        </a>
                    </div>
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button type="submit" tabindex="3" name="btn_buyer_login" class="login100-form-btn">
                                Login
                            </button>
                        </div>
                    </div>
                    <hr/>
                    <a href="signup-buyer.php" class="txt2" tabindex="5" style="float:right">Signup</a>
