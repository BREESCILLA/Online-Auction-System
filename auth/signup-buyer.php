...
<html lang="en">
<head>
    <title>Signup | Buyer - Online Auction System</title>
    <meta charset="UTF-8">
                ...
                <form class="login100-form validate-form" action="/project_adi/controllers/auth-controller.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="wrap-input100 validate-input m-b-10" data-validate="License No. is required">
                                ...
                                <input class="input100" type="text" name="txt_licenseno" placeholder="License Number" tabindex="2">
                                <span class="focus-input100" data-symbol="&#xf206;"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button type="submit" tabindex="7" name="btn_buyer_signup" class="login100-form-btn">
                                Signup
                            </button>
                        </div>
                    </div>
                    <hr/>
                    <a href="login-buyer.php" class="txt2" tabindex="8" style="float:right">Already have an account? Login</a>
